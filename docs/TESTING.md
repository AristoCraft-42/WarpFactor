...
В конце — счётчик (сейчас **2002 проверки**) и ненулевой код возврата при провале.
...
и делает скриншот на каждом шаге. Сейчас **237 проверок**, около 8 минут. Флаг `--autoshot` сам включает читы: сценарий нажимает
