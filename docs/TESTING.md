...
В конце — счётчик (сейчас **1922 проверки**) и ненулевой код возврата при провале.
...
и делает скриншот на каждом шаге. Сейчас **215 проверок**, около 8 минут. Флаг `--autoshot` сам включает читы: сценарий нажимает
