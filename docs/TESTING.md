...
В конце — счётчик (сейчас **1976 проверок**) и ненулевой код возврата при провале.
...
и делает скриншот на каждом шаге. Сейчас **232 проверки**, около 8 минут. Флаг `--autoshot` сам включает читы: сценарий нажимает
