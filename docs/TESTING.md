...
В конце — счётчик (сейчас **1929 проверок**) и ненулевой код возврата при провале.
...
и делает скриншот на каждом шаге. Сейчас **219 проверок**, около 8 минут. Флаг `--autoshot` сам включает читы: сценарий нажимает
