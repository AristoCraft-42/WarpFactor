...
В конце — счётчик (сейчас **1222 проверки**) и ненулевой код возврата при провале.
...
| Производство | `_test_furnace`, `_test_assembler_power`, `_test_crafter_contents`, `_test_output_blocked`, `_test_drill_*`, `_test_coal_drill` |
...
| Исследования и этажи | `_test_research`, `_test_research_tree`, `_test_research_queue`, `_test_research_effects_and_floors`, `_test_gateway_ports`, `_test_lift` |
...
и делает скриншот на каждом шаге. Сейчас **179 проверок**, около 130 секунд.

Сценарии: `_run_menu`, `_run_game`, `_run_drone`, `_run_interaction`, `_run_build_helpers`,
`_run_coal_drill`, `_run_production_chain`, `_run_factory`, `_run_logistics`, `_run_power`, `_run_research`,
...
| Бенчмарк | Результат |
|---|---|
| Ленты (движущиеся) | ~4.0 мс на тик |
| Сохранение / загрузка | ~42 мс запись, ~327 мс чтение |
| Враги | тик забега ~9.3 мс, из них враги ~3.1 мс |
