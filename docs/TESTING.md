...
В конце — счётчик (сейчас **1930 проверок**) и ненулевой код возврата при провале.
...
и делает скриншот на каждом шаге. Сейчас **223 проверки**, около 8 минут. Флаг `--autoshot` сам включает читы: сценарий нажимает
