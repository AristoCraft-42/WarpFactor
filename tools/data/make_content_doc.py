...
w("")
w("Реализованы столбцы **Early game**, **Early midgame** и первая колонка **Midgame** из заметок")
w("в Obsidian (`WarpFactor/Заметки.md`): сфалерит и цепочка до микросхем и наборов II.")
w("Дальше (нефть, боксит, киноварь, аутунит) пока не трогаем.")
...
w("")
w("- Дрон: добыча = 2.5 + 1 × твёрдость с на предмет, твёрдость до 1 (малахит и сфалерит — только буром).")
...
EFFECT_TEXT = {
    ...
    "boiler_floor": "котельная: четвёртый этаж с озером воды и шахтой, которая проводит ток и трубы",
