...
table(["Правило", "Как работает"], [
    ["Добыча дроном", "2.5 + 1 × твёрдость секунд на предмет; твёрдость только до 1 (малахит и сфалерит — буром)"],
    ["Добыча буром", "(6 + 1.5 × твёрдость) / число тайлов руды под ним, 90 кВт"],
